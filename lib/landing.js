...
export const TESTIMONIALS = [
  {
    quote:
      "Bro, Splitzy saved my friend group. No more 'who paid for the fries?' debates at 2AM.",
    name: "Aarav M.",
    image: "/testimonials/user1.png",
    role: "College Student & Snack Enthusiast",
  },
  {
    quote:
      "Splitzy does the math so I don’t have to. Honestly feels like cheating… and I love it.",
    name: "Kriti S.",
    image: "/testimonials/user3.png",
    role: "Part-Time Creator, Full-Time Broke",
  },
  {
    quote:
      "Ever since we started using Splitzy, my group stopped fighting over ₹20. Peace has been restored.",
    name: "Zayden R.",
    image: "/testimonials/user2.png",
    role: "Trip Planner of the Crew",
  },
];
